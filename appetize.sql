...
CREATE TABLE IF NOT EXISTS `forms` (
  ...
  `notified_staff` int(1) NOT NULL DEFAULT '0',
  `comments` text COLLATE utf8_bin,
  `user` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Daily input and reviews from students are saved here.\r\n';
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `gluten` int(1) NOT NULL DEFAULT '0',
  `class` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
